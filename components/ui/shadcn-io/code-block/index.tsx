...
export const CodeBlock = ({
	...
	return (
		<CodeBlockContext.Provider value={{ value, onValueChange, data }}>
			<div
				className={cn(
					'size-full overflow-hidden rounded-md border border-gray-400/40 shadow shadow-gray-400/25',
					theme === 'dark'
...
export const CodeBlockHeader = ({
	...
	return (
		<div
			className={cn(
				'bg-secondary flex flex-row items-center border-b border-gray-400/40 p-1',
...
export const CodeBlockContent = ({
	...
	return (
		<div
			className={cn(theme === 'dark' ? 'bg-black' : 'bg-white')}
